...
const uint8_t disable_gsa_sent[] PROGMEM = {
    0xB5, 0x62, 0x06, 0x01, 0x08, 0x00, 0xF0, 0x02, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x01, 0x02, 0x32
};

const uint8_t disable_gsv_sent[] PROGMEM = {
    0xB5, 0x62, 0x06, 0x01, 0x08, 0x00, 0xF0, 0x03, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x01, 0x03, 0x39

};

const uint8_t disable_gll_sent[] PROGMEM = {
    0xB5, 0x62, 0x06, 0x01, 0x08, 0x00, 0xF0, 0x01, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x2B
};

const uint8_t disable_vtg_sent[] PROGMEM = {
    0xB5, 0x62, 0x06, 0x01, 0x08, 0x00, 0xF0, 0x05, 0x00,
...
bool setup_gps() {
    ...
    // no acks for nmea commands
    sendUBX(disable_gsa_sent, sizeof(disable_gsa_sent) / sizeof(uint8_t));
    sendUBX(disable_gsv_sent, sizeof(disable_gsv_sent) / sizeof(uint8_t));
    sendUBX(disable_gll_sent, sizeof(disable_gll_sent) / sizeof(uint8_t));
    sendUBX(disable_vtg_sent, sizeof(disable_vtg_sent) / sizeof(uint8_t));
